Feature: Calcular Tarifa Taxi calculate total with additional charges

  Scenario: As an user I want to be able to open the calcular tarifa taxi screen from the side menu and calculate the Total for 150 units with additional charges
